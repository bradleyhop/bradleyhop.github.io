...
$calc-body-border: #5e6d68;
$lcd-background: #000;
$lcd-boder: #ebecf0;
$button-container-background: #e9ebdd;
$button-font-color: #3b3b3b;
$button-font-color-active: #fff;
$button-light-grey: #f8f8f8;
$button-dark-grey: #c8cccb;
$button-orange: #fdb94c;
...
.calc-body {
  background-color: $calc-body-background;
  border: 10px solid $calc-body-border;
  border-radius: 4px;
  margin: auto;
  padding-bottom: 1rem;
  padding-top: 1.5rem;
...
.lcd-container {
  ...
  font-family: 'Digital7Mono', Courier, monospace;
